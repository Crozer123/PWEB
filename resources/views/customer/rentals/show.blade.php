...
<div class="min-h-screen bg-gray-50 py-10 font-poppins">
    ...
    <div class="max-w-5xl mx-auto px-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 mb-8">
            ...
            <div class="grid md:grid-cols-2 gap-6 text-sm">
                <div>
                    ...
                    <p class="font-semibold text-gray-800">{{ $rental->created_at->format('d M Y - H:i') }} WIB</p>
                </div>
                <div>
                    <p class="text-gray-500">Tanggal Pengembalian</p>
                    <p class="font-semibold text-gray-800">{{ $rental->return_date ? \Carbon\Carbon::parse($rental->return_date)->format('d M Y') : '-' }}</p>
                </div>
                <div>
                    <p class="text-gray-500">Total Harga</p>
                    <p class="font-semibold text-gray-800">Rp {{ number_format($rental->total_price, 0, ',', '.') }}</p>
                </div>
                <div>
                    <p class="text-gray-500">Jumlah Barang</p>
                    <p class="font-semibold text-gray-800">{{ $rental->items->count() }} item</p>
                </div>
            </div>
        </div>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between border-b pb-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="w-20 h-20 rounded-lg overflow-hidden bg-gray-50 border border-gray-200 flex-shrink-0">
                            @if($item->image)
        ...
        <div class="bg-emerald-600 text-white rounded-xl p-6 flex items-center justify-between shadow-lg">
            ...
            <a href="https://wa.me/6283869634931" target="_blank" class="bg-white text-emerald-700 px-5 py-3 rounded-lg font-semibold shadow hover:bg-gray-100 transition">
