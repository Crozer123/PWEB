                        ...
                        <tr class="hover:bg-slate-50/80 transition duration-200 group">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-left">
                                <div class="flex items-center justify-start gap-1">
                                    ...
                                    <form action="{{ route('admin.items.destroy', $item) }}" method="POST" class="inline-block form-delete">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" onclick="confirmDelete(this)" class="group/btn relative p-2 rounded-lg text-slate-400 hover:text-rose-600 hover:bg-rose-50 transition-all duration-200">
...
<script>
    function confirmDelete(button) {
        Swal.fire({
            ...
            text: "Item yang dihapus tidak dapat dikembalikan! Pastikan item ini tidak sedang disewa.",
            icon: 'warning',
