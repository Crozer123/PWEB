...
<div class="min-h-screen relative overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img src="https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=1920" 
        ...
        <div class="flex justify-center items-center min-h-screen">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-8">
                    ...
                    <!-- BRAND DIGANTI -->
                    <h1 class="text-4xl font-bold text-white mb-2">For Reast</h1>

                    <p class="text-green-200 text-lg">Adventure Awaits You</p>
                </div>

                <!-- Login Card -->
                <div class="bg-white/95 backdrop-blur-md shadow-2xl rounded-2xl overflow-hidden border border-white/20">
                    <!-- Header with Icon -->
                    <div class="bg-gradient-to-r from-green-600 via-green-500 to-teal-500 px-8 py-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <h2 class="text-2xl font-bold text-white">{{ __('Welcome Back') }}</h2>
                                <p class="text-green-100 text-sm mt-1">{{ __('Login to start your adventure') }}</p>
                            </div>
                        ...
                        <form method="POST" action="{{ route('login.post') }}">
                            ...
                            <div class="flex items-center justify-between mb-6">
                                <div class="flex items-center">
                                    ...
                                    <label class="ml-2 text-sm text-gray-700 font-medium" for="remember">
                                        {{ __('Remember Me') }}
                                    </label>
                                </div>
                                
                                @if (Route::has('password.request'))
                                    <a class="text-sm text-green-600 hover:text-green-800 font-semibold hover:underline" href="{{ route('password.request') }}">
                                        {{ __('Forgot Password?') }}
                                    </a>
                                @endif
                            </div>
                            ...
                            <div class="relative mb-6">
                                ...
                                <div class="relative flex justify-center text-sm">
                                    <span class="px-4 bg-white text-gray-500 font-medium">{{ __('New to Outdoor Rental?') }}</span>
                                </div>
                            </div>

                            <!-- Register Link -->
                            <div class="text-center">
                                <a class="inline-flex items-center justify-center w-full bg-white border-2 border-green-600 text-green-600 hover:bg-green-50 font-bold py-3 px-4 rounded-xl transition duration-300 ease-in-out transform hover:scale-[1.02]" href="{{ route('register') }}">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-8 text-center">
                    <p class="text-white/80 text-sm flex items-center justify-center">
                        ...
                        {{ __('Your adventure starts here. Secure & trusted.') }}
                    </p>
                </div>
            </div>
        </div>
